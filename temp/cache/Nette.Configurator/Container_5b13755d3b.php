<?php
// source: C:\xampp\htdocs\cviceni02a\app/config/config.neon 
// source: C:\xampp\htdocs\cviceni02a\app/config/config.local.neon 

class Container_5b13755d3b extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\BaseModel' => [
				1 => [
					'24_App_Model_OrderModel',
					'25_App_Model_StatisticModel',
					'26_App_Model_UserModel',
				],
			],
			'Nette\Object' => [
				1 => [
			...
			'App\Model\OrderModel' => [1 => ['24_App_Model_OrderModel']],
			'App\Model\StatisticModel' => [1 => ['25_App_Model_StatisticModel']],
			'App\Model\UserModel' => [1 => ['26_App_Model_UserModel']],
			'App\Forms\OrderFormFactory' => [1 => ['orderservice']],
			'App\Forms\UserFormFactory' => [1 => ['userservice']],
			...
			'App\Presenters\OrderPresenter' => [1 => ['application.4']],
			'App\Presenters\StatisticPresenter' => [1 => ['application.5']],
		...
		'services' => [
			'24_App_Model_OrderModel' => 'App\Model\OrderModel',
			'25_App_Model_StatisticModel' => 'App\Model\StatisticModel',
			'26_App_Model_UserModel' => 'App\Model\UserModel',
			...
			'application.4' => 'App\Presenters\OrderPresenter',
			'application.5' => 'App\Presenters\StatisticPresenter',
			...
			'orderservice' => 'App\Forms\OrderFormFactory',
			...
			'userservice' => 'App\Forms\UserFormFactory',
		],
		'tags' => [
			'inject' => [
				'application.1' => TRUE,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\cviceni02a\app',
			'wwwDir' => 'C:\xampp\htdocs\cviceni02a\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\cviceni02a\app/../temp',
		];
	}
	 ...
	 */
	public function createService__24_App_Model_OrderModel()
	{
		$service = new App\Model\OrderModel($this->getService('database.default.context'));
		return $service;
	}
	 ...
	 */
	public function createService__25_App_Model_StatisticModel()
	{
	 ...
	 */
	public function createService__26_App_Model_UserModel()
	{
	...
	{
		$service = new App\Presenters\OrderPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('orderservice'), $this->getService('24_App_Model_OrderModel'),
			$this->getService('26_App_Model_UserModel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__5()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('25_App_Model_StatisticModel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__6()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('userservice'), $this->getService('26_App_Model_UserModel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\cviceni02a\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\cviceni02a\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\cviceni02a\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=cviceni02a', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_5b13755d3b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	/**
	 * @return App\Forms\OrderFormFactory
	 */
	public function createServiceOrderservice()
	{
		$service = new App\Forms\OrderFormFactory;
		$service->injectDependencies($this->getService('24_App_Model_OrderModel'));
		return $service;
	}
	 ...
	 */
	public function createServiceUserservice()
	{
		$service = new App\Forms\UserFormFactory;
		$service->injectDependencies($this->getService('26_App_Model_UserModel'));
		return $service;
	}
...
class Container_5b13755d3b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_5b13755d3b $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\cviceni02a\app/../temp/cache/latte');
